...
export default function Engraved() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      <h2 className="text-xl font-semibold mb-6">Engraved Leather Watch</h2>
    <div className="flex gap-4">

  {/* LEFT BIG IMAGE */}
  <div className="w-full md:w-[392px] h-[368px] border rounded-[20px] overflow-hidden">
    <img
      src={products[0].img}
        ...
        {products.map((item, i) => (
          <SwiperSlide key={i}>
            <div className="space-y-3">
              ...
              {/* IMAGE CARD */}
              <div className="relative h-[250px] rounded-2xl overflow-hidden border bg-gray-100 mt-2.12">
